...
/* at Thu May 20 01:18:55 2010
 */
/* Compiler settings for .\GenericElevatorTranslator.idl:
...
#ifndef __GenericElevatorTranslator_h__
#define __GenericElevatorTranslator_h__
...
#ifndef __IElevatorDispatching_FWD_DEFINED__
#define __IElevatorDispatching_FWD_DEFINED__
typedef interface IElevatorDispatching IElevatorDispatching;
#endif 	/* __IElevatorDispatching_FWD_DEFINED__ */


#ifndef __ElevatorTrans_FWD_DEFINED__
#define __ElevatorTrans_FWD_DEFINED__

#ifdef __cplusplus
typedef class ElevatorTrans ElevatorTrans;
#else
typedef struct ElevatorTrans ElevatorTrans;
#endif /* __cplusplus */

#endif 	/* __ElevatorTrans_FWD_DEFINED__ */
...
/* interface __MIDL_itf_GenericElevatorTranslator_0000_0000 */
/* [local] */ 
...
typedef /* [switch_type] */ union CD4
    {
    struct __MIDL___MIDL_itf_GenericElevatorTranslator_0000_0000_0002
        {
...
typedef /* [public][public] */ struct __MIDL___MIDL_itf_GenericElevatorTranslator_0000_0000_0003
    {
...
extern RPC_IF_HANDLE __MIDL_itf_GenericElevatorTranslator_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_GenericElevatorTranslator_0000_0000_v0_0_s_ifspec;
...
#ifndef __IElevatorDispatching_INTERFACE_DEFINED__
#define __IElevatorDispatching_INTERFACE_DEFINED__

/* interface IElevatorDispatching */
/* [unique][helpstring][uuid][object] */ 


EXTERN_C const IID IID_IElevatorDispatching;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("98f89fb2-a1d2-4725-bfed-f04200b5dead")
    IElevatorDispatching : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE Lnl_SetPanelTerminals( 
            /* [in] */ ELEVATOR_KEYPAD_TERMINALS *terminalsToManage) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE Lnl_UpdateTerminal( 
            /* [in] */ ELEVATOR_TERMINAL_CONFIG *terminalConfiguration) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE Lnl_SetTerminalOperationalMode( 
            /* [in] */ long terminalID,
            /* [in] */ short operationalMode) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE Lnl_SetTerminalAllowedFloors( 
            /* [in] */ long terminalID,
            /* [in] */ ELEVATOR_FLOORLIST *allowedFloorsCfg) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE Lnl_SendTerminalCredentialData( 
            /* [in] */ long terminalID,
            /* [in] */ ELV_DISPATCHING_CREDENTIAL_DATA *credentialData) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE Lnl_GetElevatorDispatchingPanelStatus( 
            /* [out] */ BYTE *sb_ComStatus,
            /* [out] */ BYTE *sb_AsyncStatus,
            /* [out] */ long *vl_PanelStatus) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE Lnl_GetElevatorKeypadTerminalStatus( 
            /* [out] */ BYTE *sb_AsyncStatus,
            /* [in] */ long vl_NumTerminals,
            /* [size_is][out] */ BOOL sb_ComStatus[  ],
            /* [size_is][out] */ short operationalMode[  ],
            /* [size_is][out] */ ELEVATOR_FLOORLIST allowedFloorsCfg[  ]) = 0;
        
    };
    
#else 	/* C style interface */

    typedef struct IElevatorDispatchingVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            IElevatorDispatching * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ 
            __RPC__deref_out  void **ppvObject);
        ...
        HRESULT ( STDMETHODCALLTYPE *Lnl_SetPanelTerminals )( 
            IElevatorDispatching * This,
            /* [in] */ ELEVATOR_KEYPAD_TERMINALS *terminalsToManage);
        
        HRESULT ( STDMETHODCALLTYPE *Lnl_UpdateTerminal )( 
            IElevatorDispatching * This,
            /* [in] */ ELEVATOR_TERMINAL_CONFIG *terminalConfiguration);
        
        HRESULT ( STDMETHODCALLTYPE *Lnl_SetTerminalOperationalMode )( 
            IElevatorDispatching * This,
            /* [in] */ long terminalID,
            /* [in] */ short operationalMode);
        
        HRESULT ( STDMETHODCALLTYPE *Lnl_SetTerminalAllowedFloors )( 
            IElevatorDispatching * This,
            /* [in] */ long terminalID,
            /* [in] */ ELEVATOR_FLOORLIST *allowedFloorsCfg);
        
        HRESULT ( STDMETHODCALLTYPE *Lnl_SendTerminalCredentialData )( 
            IElevatorDispatching * This,
            /* [in] */ long terminalID,
            /* [in] */ ELV_DISPATCHING_CREDENTIAL_DATA *credentialData);
        
        HRESULT ( STDMETHODCALLTYPE *Lnl_GetElevatorDispatchingPanelStatus )( 
            IElevatorDispatching * This,
            /* [out] */ BYTE *sb_ComStatus,
            /* [out] */ BYTE *sb_AsyncStatus,
            /* [out] */ long *vl_PanelStatus);
        
        HRESULT ( STDMETHODCALLTYPE *Lnl_GetElevatorKeypadTerminalStatus )( 
            IElevatorDispatching * This,
            /* [out] */ BYTE *sb_AsyncStatus,
            /* [in] */ long vl_NumTerminals,
            /* [size_is][out] */ BOOL sb_ComStatus[  ],
            /* [size_is][out] */ short operationalMode[  ],
            /* [size_is][out] */ ELEVATOR_FLOORLIST allowedFloorsCfg[  ]);
        
        END_INTERFACE
    } IElevatorDispatchingVtbl;

    interface IElevatorDispatching
    {
        CONST_VTBL struct IElevatorDispatchingVtbl *lpVtbl;
    };
...
#define IElevatorDispatching_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IElevatorDispatching_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IElevatorDispatching_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IElevatorDispatching_Lnl_SetPanelTerminals(This,terminalsToManage)	\
    ( (This)->lpVtbl -> Lnl_SetPanelTerminals(This,terminalsToManage) ) 

#define IElevatorDispatching_Lnl_UpdateTerminal(This,terminalConfiguration)	\
    ( (This)->lpVtbl -> Lnl_UpdateTerminal(This,terminalConfiguration) ) 

#define IElevatorDispatching_Lnl_SetTerminalOperationalMode(This,terminalID,operationalMode)	\
    ( (This)->lpVtbl -> Lnl_SetTerminalOperationalMode(This,terminalID,operationalMode) ) 

#define IElevatorDispatching_Lnl_SetTerminalAllowedFloors(This,terminalID,allowedFloorsCfg)	\
    ( (This)->lpVtbl -> Lnl_SetTerminalAllowedFloors(This,terminalID,allowedFloorsCfg) ) 

#define IElevatorDispatching_Lnl_SendTerminalCredentialData(This,terminalID,credentialData)	\
    ( (This)->lpVtbl -> Lnl_SendTerminalCredentialData(This,terminalID,credentialData) ) 

#define IElevatorDispatching_Lnl_GetElevatorDispatchingPanelStatus(This,sb_ComStatus,sb_AsyncStatus,vl_PanelStatus)	\
    ( (This)->lpVtbl -> Lnl_GetElevatorDispatchingPanelStatus(This,sb_ComStatus,sb_AsyncStatus,vl_PanelStatus) ) 

#define IElevatorDispatching_Lnl_GetElevatorKeypadTerminalStatus(This,sb_AsyncStatus,vl_NumTerminals,sb_ComStatus,operationalMode,allowedFloorsCfg)	\
    ( (This)->lpVtbl -> Lnl_GetElevatorKeypadTerminalStatus(This,sb_AsyncStatus,vl_NumTerminals,sb_ComStatus,operationalMode,allowedFloorsCfg) ) 
...
#endif 	/* __IElevatorDispatching_INTERFACE_DEFINED__ */



#ifndef __GENERICELEVATORTRANSLATORLib_LIBRARY_DEFINED__
#define __GENERICELEVATORTRANSLATORLib_LIBRARY_DEFINED__

/* library GENERICELEVATORTRANSLATORLib */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_GENERICELEVATORTRANSLATORLib;

EXTERN_C const CLSID CLSID_ElevatorTrans;

#ifdef __cplusplus

class DECLSPEC_UUID("DF8AE50F-5DD7-4566-B58D-040F708E3133")
ElevatorTrans;
#endif
#endif /* __GENERICELEVATORTRANSLATORLib_LIBRARY_DEFINED__ */
